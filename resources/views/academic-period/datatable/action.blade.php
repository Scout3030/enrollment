<div class="btn-group">
    ...
    <div class="dropdown-menu dropdown-menu-end">
        ...
        <a href="{{ route('academic-periods.edit', $id) }}" class="dropdown-item">
        ...
        <a href="javascript:void(0)" class="dropdown-item delete-record deleteAcademicPeriod" data-bs-toggle="modal"
