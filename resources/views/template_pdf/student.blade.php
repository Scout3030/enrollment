        ...
        <div class="row">
            ...
            <table class="tftable" border="2">
                ...
                @endif
                 ...
                 <tr><td colspan="1">DNI:</td><td colspan="1">{{  $student->dni }}</td><td colspan="2">NACIONALIDAD:</td><td colspan="4">  {{ $student->user->student->country ? $student->user->student->country->name : '-' }}</td></tr>
                <tr><td colspan="1">FECHA DE NACIMIENTO:</td><td colspan="1"> {{ ( $student->birth)->toDateString(); }}</td><td colspan="3">LUGAR DE NACIMIENTO:</td><td colspan="3">  {{ $student->user->student->country ? $student->user->student->country->name : '-' }}</td></tr>
                <tr><td colspan="1">DOMICILIO ACTUAL:</td><td colspan="7">{{  $student->address }}, Calle {{ $student->address_number }}</td></tr>
                <tr><td colspan="1">TELEFONOS PARA URGENCIAS:</td><td colspan="7"></td></tr>
