                        ...
                        <div class="demo-inline-spacing">
                            <div class="modal-content">
                                <ul class="head-links nav nav-tabs nav-tabs-custom nav-justified">
                                    ...
                                    <li type="upload" class="nav-item"><a data-toggle="tab" class="nav-link" aria-selected="false" href="#upload">Upload</a></li>
                                    <li type="draw" class="nav-item"><a data-toggle="tab"  class="nav-link" aria-selected="false" href="#draw">Draw</a></li>
                                </ul>
