...
(function() { // Comenzamos una funcion auto-ejecutable
	...
	var canvas = document.getElementById("draw-canvasstudent");
	var ctx = canvas.getContext("2d");

	
	// Mandamos llamar a los Elemetos interactivos de la Interfaz HTML
	var drawText = document.getElementById("draw-dataUrlstudent");
//	var drawImage = document.getElementById("draw-image");
	var clearBtn = document.getElementById("draw-clearBtnstudent");
	var submitBtn = document.getElementById("draw-submitBtnstudent");
	...
	canvas.addEventListener("mousedown", function (e)
  {
    ...
    */
		var tint = document.getElementById("colorstudent");
