...
(function() { // Comenzamos una funcion auto-ejecutable
	...
	var canvas = document.getElementById("draw-canvastutor1");
	var ctx = canvas.getContext("2d");


	// Mandamos llamar a los Elemetos interactivos de la Interfaz HTML
	var drawText = document.getElementById("draw-dataUrltutor1");
//	var drawImage = document.getElementById("draw-image");
	var clearBtn = document.getElementById("draw-clearBtntutor1");
	var submitBtn = document.getElementById("draw-submitBtntutor1");
   ...
   singData = $(".head-links-tutor1").find("li.active").attr("type")
    saveSignature(dataUrl,singData);
