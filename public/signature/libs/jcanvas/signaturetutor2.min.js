...
(function() { // Comenzamos una funcion auto-ejecutable
	...
	var canvas = document.getElementById("draw-canvastutor2");
	var ctx = canvas.getContext("2d");

	
	// Mandamos llamar a los Elemetos interactivos de la Interfaz HTML
	var drawText = document.getElementById("draw-dataUrltutor2");
//	var drawImage = document.getElementById("draw-image");
	var clearBtn = document.getElementById("draw-clearBtntutor2");
	var submitBtn = document.getElementById("draw-submitBtntutor2");
	...
	canvas.addEventListener("mousedown", function (e)
  {
    ...
    */
		var tint = document.getElementById("colortutor2");
